...
public class VendorProfileBean {
  ...
  List<OffersAndFeedbackBean> offersAndFeedbackBean;
  ...
  public VendorProfileBean(String id, String firstName, String lastName, String email, AddressBean shopAddress,
      String vendorMobileNo, List<OffersAndFeedbackBean> offersAndFeedbackBean) {
    super();
    this.id = id;
  ...
  public List<OffersAndFeedbackBean> getOffersAndFeedbackBean() {
    return offersAndFeedbackBean;
  }
  public void setOffersAndFeedbackBean(List<OffersAndFeedbackBean> offersAndFeedbackBean) {
    this.offersAndFeedbackBean = offersAndFeedbackBean;
  }
